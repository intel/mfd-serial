...
# MFD-Serial documentation build configuration file, created by
...
htmlhelp_basename = "mfd-serial-doc"
...
latex_documents = [
    (master_doc, "mfd-serial.tex", "MFD-Serial Documentation", "author", "manual"),
]
...
man_pages = [(master_doc, "mfd-serial", "MFD-Serial Documentation", [author], 1)]
